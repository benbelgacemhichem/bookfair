    ...
    <div class="container-fluid ">
        ...
        <section class="highlights mt-3">
            <div class="d-flex d-flex justify-content-center" style="text-align: center;">
                <div class="m-2">
                    <a href="" data-toggle="modal" data-target="{{ $active ? '#bagModal' : '' }}" onclick="selectBag('Bag 1', {{ $active }})">
                        <div class="card">
                ...
                <div class="m-2">
                    <a href="" data-toggle="modal" data-target="{{ $active ? '#bagModal' : '' }}" onclick="selectBag('Bag 2', {{ $active }})">
                        <div class="card ">
                ...
                <div class="m-2">
                    <a href="" data-toggle="modal" data-target="{{ $active ? '#bagModal' : '' }}" onclick="selectBag('Bag 3', {{ $active }})">
                        <div class="card ">
                ...
                <div class="modal-content">
                    ...
                    <form id="visitor_form" method="post" action="{{ route('bags.submit') }}">
                        ...
                        <div class="modal-body">
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <h5 class="text-center text-dark"><strong>الرجاء ادخال المعلومات لاستكمال
                                            الطلب</strong></h5>
                                </div>
                            </div>
                            <input type="hidden" id="bag-style-input" name="bag_style">
                            <div class="row mb-3">
                                <div class="col-md-3"><label>الاسم الكامل<small class="text-danger">*</small></label>
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-3"><label>البريد الالكتروني<small
                                            class="text-danger">*</small></label></div>
                                <div class="col-md-9">
                                    <input type="email" class="form-control" name="email" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-3"><label>رقم الجوال<small class="text-danger">*</small></label>
                                </div>
                                <div class="col-md-9">
    ...
    <script type="text/javascript">
        function selectBag(title, active) {
            if (active == 0) {
                Swal.fire({
                    title: "عذراً",
                    text: 'لا يمكننا معالجة طلبك في الوقت الحالي. يُرجى إعادة المحاولة لاحقاً',
                    icon: "warning",
                })
                $('#bagModal').modal('hide')
            } else {
